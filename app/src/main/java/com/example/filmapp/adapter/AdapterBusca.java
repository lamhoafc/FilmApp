...
import com.example.filmapp.activity.DetalhePostActivity;
...
public class AdapterBusca extends RecyclerView.Adapter<AdapterBusca.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_list_search, parent, false);
